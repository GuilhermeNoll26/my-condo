...
class CashesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cash" do
    assert_difference('Cash.count') do
      post cashes_url, params: { cash: { balance: @cash.balance, description: @cash.description } }
    end
  ...
  test "should update cash" do
    patch cash_url(@cash), params: { cash: { balance: @cash.balance, description: @cash.description } }
