...
class ExpendituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expenditure" do
    assert_difference('Expenditure.count') do
      post expenditures_url, params: { expenditure: { comments: @expenditure.comments, expenditure_type: @expenditure.expenditure_type, value: @expenditure.value } }
    end
  ...
  test "should update expenditure" do
    patch expenditure_url(@expenditure), params: { expenditure: { comments: @expenditure.comments, expenditure_type: @expenditure.expenditure_type, value: @expenditure.value } }
