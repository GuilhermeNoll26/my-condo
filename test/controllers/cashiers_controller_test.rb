...
class CashiersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cashier" do
    assert_difference('Cashier.count') do
      post cashiers_url, params: { cashier: { balance: @cashier.balance, description: @cashier.description } }
    end
  ...
  test "should update cashier" do
    patch cashier_url(@cashier), params: { cashier: { balance: @cashier.balance, description: @cashier.description } }
